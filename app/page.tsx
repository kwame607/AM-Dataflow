    ...
    <>
      ...
      <header className="store-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div>
            <div className="store-header-name" style={{ fontFamily: 'Syne, sans-serif', fontSize: 18, fontWeight: 800, letterSpacing: '-0.5px', lineHeight: 1, color: 'var(--text)' }}>{STORE_NAME}</div>
        ...
        <div className="store-header-btns" style={{ display: 'flex', gap: 8 }}>
          <button className="btn btn-secondary btn-sm" onClick={() => setTrackOpen(true)}>
            ...
            <span className="store-btn-label">Track Order</span>
          </button>
