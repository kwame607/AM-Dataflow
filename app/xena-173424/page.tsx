...
type Tab = 'overview' | 'orders' | 'wallets' | 'agents' | 'prices' | 'withdrawals' | 'settings' | 'finance' | 'support';
...
export default function AdminPage() {
  ...
  const navItems: { id: Tab; label: string; icon: React.ReactNode; badge?: number }[] = [
    ...
    { id: 'wallets', label: 'Wallets', icon: <svg width="17" height="17" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg> },
    ...
    <div className="sidebar-layout">
      ...
      <main className="main-content">
        <div className="page-body">
          ...
          {/* WALLET */}
          {tab === 'wallets' && (
  <AdminWalletTab agents={agents} authFetch={authFetch} toast={toast} />
)}
